    ...
    <section className=' py-[150px] bg-[url("/banner.png")] bg-no-repeat bg-center bg-cover'>
      <div className="container">
        <div className=" w-1/2 bg-[#FFF3E3] ml-auto pt-14 pb-9 px-10 rounded-xl">
          ...
          <h1 className="text-[52px] font-primary font-bold text-brand leading-[65px] w-[400px] pt-1 pb-4">
            Discover Our New Collection
          </h1>
          <p className=" text-lg font-primary text-primary font- font-medium pb-11">
